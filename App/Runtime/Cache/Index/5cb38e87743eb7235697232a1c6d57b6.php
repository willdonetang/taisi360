...
<html lang="zh-cn">
  <head>
    ...
    <title><?php echo R('Siteinfo/info',array('title'),'Widget');?>注册</title>
...
<body>
 ...
 <a href="<?php echo U('Index/Login/index');?>" class="btn btn-link" style="float:right" title="注册">已有账号</a><a href="<?php echo U('Index/Index/index');?>" class="btn btn-link" style="float:right" title="返回">>>返回首页</a>
          </div>

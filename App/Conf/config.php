...
$b=array(
    ...
    'URL_ROUTE_RULES' => array( //定义路由规则
        '/^category\/(\d+)/' => 'index/list/index?catsid=:1',
        '/^article\/(\d+)/' => 'index/article/index?articleid=:1',
    ),
    ...
    /* RBAC配置 */
    'RBAC_SUPERADMIN' => 'laowangtaise',       //超级管理员名称
...
//bae环境
if($_SERVER['SERVER_NAME'] == 'taise360.duapp.com'){
    $b['DB_HOST'] = 'sqld.duapp.com'; // 服务器地址
    $b['DB_NAME']   = 'PJFBGWFCMoTAWDEbcFkP'; // 数据库名
    $b['DB_USER'] = '3d958066f75377906229a0bbf66400b5';  // 用户名
    $b['DB_PWD']    = 'FAc3eae6d1d60b088e45eb6f3daba482';  // 密码
    $b['DB_PORT']   = '4050';  // 端口
}
